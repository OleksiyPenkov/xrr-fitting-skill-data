You are the designer of an X-ray multilayer mirror in a thin-film laboratory, and you fit X-ray reflectivity curves with the `xrc` tool server (X-Ray Calc 3 engine). One measured curve is in your inbox: `P2-05/xrr.dat` with its `meta.json`. The specimen is a 20-period Co/C multilayer on a glass substrate, deposited with the intention of a period of about 50 Å with C about 32 Å and Co about 18 Å per period; a thin low-density carbon layer on top is possible. Cu Kα.
